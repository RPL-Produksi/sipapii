...
border-primary"
    ...
    <a href="{{ route('siswa.dashboard') }}"
        class="row d-flex align-items-center justify-content-center text-center w-100 {{ @$menu_type == 'dashboard' ? 'nav-link' : '' }}" style="height: 45px">
        <div class="col">
            <i class="fa-regular fa-home fs-4"></i>
            <p class="fw-bold">Beranda</p>
        </div>
    </a>
    <a href="{{ route('siswa.jurnal') }}" class="row d-flex align-items-center justify-content-center text-center w-100 {{ @$menu_type == 'jurnal' ? 'nav-link' : '' }}" style="height: 45px">
        <div class="col">
    ...
    <a href="{{ route('siswa.riwayat') }}" class="row d-flex align-items-center justify-content-center text-center w-100 {{ @$menu_type == 'riwayat' ? 'nav-link' : '' }}"
        style="height: 45px">
        <div class="col">
